...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pascal/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pascal/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pascal**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pascal",
...
- [ ] Changes are scoped to `pascal` — do not include files for other languages
